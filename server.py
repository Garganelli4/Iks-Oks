from ServerConnection import SqlServerConnection
...
class SocketServer(socket.socket):
    def __init__(self):
        ...
        socketHostData = (socket.gethostname(), 65432)
    ...
    def registration_manager(self, userCredentials):
        ...
        try:
            ...
            if userCredentials_fromDB == None:
                ...
                hashedPassword = hashlib.md5() # set hashing algorithm to MD5
    ...
    def login_manager(self, userCredentials):
