...
class ClientServerSocket(socket.socket):
    ...
    def __init__(self, socketHostData=(socket.gethostname(), 6543)):
    ...
    # This will get passed in a username and password -> the socket server will validate the user's Credential
